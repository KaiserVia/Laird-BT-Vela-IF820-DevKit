...
//   </e>
//
//   <e5> PLL1 Configuration (USB PLL) - Modfiziert!
...
#define CCLKCFG_Val           0x0000000B
#define USBCLKCFG_Val         0x00000005
#define PCLKSEL0_Val          0x031000B0
#define PCLKSEL1_Val          0x0C00F000
#define PCONP_Val             0x20C1848C
...
#define FLASHCFG_Val          0x00001000
...
void SystemInit (void)
{
  ...
  LPC_SC->PLL1CON   = 0x02;             // PLL1 Connect only, damit bleibt USB Block ohne Clock             
  LPC_SC->PLL1FEED  = 0xAA;
  LPC_SC->PLL1FEED  = 0x55;
